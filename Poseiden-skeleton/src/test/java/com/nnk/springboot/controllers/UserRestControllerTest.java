...
public class UserRestControllerTest {
   ...
   * @Test
   * 
   * @WithMockUser(roles = "ADMIN") public void testDeleteUser() throws Exception
   * { Integer id = 1; user = new User(); User user2 = null;
   * 
   ...
   * @Test
   * 
   * @WithMockUser(roles = "ADMIN") public void testDeleteUserIfidDoesntExist()
   * throws Exception { Integer id = 1; user = new User();
   * 
